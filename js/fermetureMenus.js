document.addEventListener("DOMContentLoaded", () => {
  ...
  */
  ...
  function fermerFooter(e) {
    ...
    if (
      e == "menu" ||
      e.target == checkAPropos ||
      e.target == checkSocials ||
      e.target == checkContact
    ) {
      console.log("return");
      return;
    } else if (
      e.target.id == "footProp" ||
      trouverParents(e.target, "footProp")
    ) {
      ...
      e.target.id == "footSoc" ||
      trouverParents(e.target, "footSoc")
    ) {
      if (!footSuisChecked) {
        console.log("suivi");
        checkAPropos.checked = false;
      ...
      e.target.id == "footCont" ||
      trouverParents(e.target, "footCont")
    ) {
      if (!footContChecked) {
        console.log("contenu");
        checkAPropos.checked = false;
